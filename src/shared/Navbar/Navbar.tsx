...
const Navbar: React.FC = () => {
  const active = 'block py-2 md:p-4 hover:text-purple-400 text-purple-500';
  const inactive = 'block py-2 md:p-4 hover:text-purple-400';
  return (
    <nav className="flex flex-wrap items-center justify-between w-full px-4 py-4 text-lg text-gray-700 bg-white md:py-0">
      ...
      >
        <ul className="pt-4 text-base text-gray-700 md:flex md:justify-between md:pt-0">
          <li>
            {/* activeClassName is doesn't exist in react-router-dom v6 anymore */}
            <NavLink
